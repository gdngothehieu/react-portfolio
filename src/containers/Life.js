  ...
  render() {
    return (
      <div>
        <div>
          <CenteredHeader>
            I like to create, regardless of medium. Here are some of my current
            artistic projects:
          </CenteredHeader>
        </div>
        {/*Row 1*/}
        <LifeRow className="row">
          ...
          <div className="col-md-6 col-sm-12">
            ...
            <LifeProjectBlurb>
              I write poetry on the sidewalks, because street art makes the
        ...
        <div className="row">
          <div className="col-md-6 col-sm-12">
            ...
            <LifeProjectBlurb>
              I'm into creative writing. Here's where i put all of my unfinished
              poetic tidbits. And hey -- all art is unfinished, right?
            </LifeProjectBlurb>
          </div>
          <div className="col-md-6 col-sm-12">
            <a
            ...
            >
              ...
              <LifeHeader>jenny & Brightlight sing</LifeHeader>
            </a>
            <LifeProjectBlurb>
              My best friend and i make acoustic covers of songs. Listen to us
              here!
            </LifeProjectBlurb>
          </div>
        </div>
